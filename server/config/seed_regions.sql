-- regions 시드 — 시/도 · 시/군/구 기초자치단체 229행 (2024년 행정구역 기준: 강원·전북 특별자치도, 군위군→대구)
-- 적용: schema.sql 실행 후 SQL Editor 에서 실행. 다시 실행해도 됨 (on conflict do nothing).
-- 크루 생성·프로필 지역 설정은 이 시드가 있어야 FK 를 통과함.
...
-- 경상북도 (22)
  ('경상북도','포항시'), ('경상북도','경주시'), ('경상북도','김천시'), ('경상북도','안동시'), ('경상북도','구미시'), ('경상북도','영주시'), ('경상북도','영천시'), ('경상북도','상주시'), ('경상북도','문경시'), ('경상북도','경산시'), ('경상북도','의성군'), ('경상북도','청송군'), ('경상북도','영양군'), ('경상북도','영덕군'), ('경상북도','청도군'), ('경상북도','고령군'), ('경상북도','성주군'), ('경상북도','칠곡군'), ('경상북도','예천군'), ('경상북도','봉화군'), ('경상북도','울진군'), ('경상북도','울릉군'),
-- 경상남도 (18)
