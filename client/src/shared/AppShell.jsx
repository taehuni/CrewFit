  ...
  return (
    <div className="workspace">
      ...
      <nav className="ws-nav" aria-label="주요 메뉴">
        ...
        {TABS.map((t) => {
          const active = (t.paths || [t.to]).some(path => pathname === path || pathname.startsWith(path + '/'));
          return <Link key={t.to} to={t.to} className="ws-nav-item" aria-current={active ? 'page' : undefined}>
